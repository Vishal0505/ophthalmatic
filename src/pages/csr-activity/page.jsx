...
export default function CsrActivity() {
  ...
  return (
    <Flex direction="column">
      <Breadcrumb
        title="Corporate"
        secondaryTitle="Social Responsibility"
        path="csr-activity"
        label="CSR"
      />
      <Container className="my-12">
        <Flex direction="column" gap="8">
          <Text className="text-lg text-center text-gray-800">
            At Gadhiya Foundation, we believe that true progress begins with the
            health and happiness of our community. Our Free Eye Check-Up Camp
            embodies our dedication to community development, sustainable
            progress, and social welfare. This special event provides essential
            eye care services - including comprehensive eye exams and
            prescription glasses - at no cost to individuals in need. Our
            commitment extends beyond immediate care; we aim to foster long-term
            well-being and empowerment by addressing critical health needs
            sustainably. By focusing on improving vision and promoting eye
            health, we contribute to a healthier, more informed community where
