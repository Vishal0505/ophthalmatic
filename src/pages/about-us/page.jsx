      ...
      <Container>
        <Flex direction="column" gap="8">
          <Flex
            align="center"
            justify="center"
            className={`flex-col sm:flex-row ${isAboutPage && "mt-12"}`}
            gap="7"
          >
            <Flex className="flex-1">
              <img src={about_us} alt="About Us" className="w-full h-auto" />
            </Flex>
            <Flex className="flex-1 gap-5" direction="column">
              ...
              <Flex direction="column" gap="3">
                <Flex>
                  <Text>
                    Ophthalmatic is a leading medical equipment manufacturing
                    company known for its quality, reliability, and
                    technological innovations. Their ophthalmological equipment
                    range is produced using cutting-edge technology, meeting
                    global industry standards. The designs reflect a deep
                    understanding of ophthalmologist’s real needs, gathered by
                    the company’s founders over many years. Their competitive
                    edge is enhanced by prompt delivery, dedicated after-sales
                    support, and valuable technical advice.
                  </Text>
                </Flex>
                {!isAboutPage && (
                  <Flex className="justify-center">
            ...
            <>
                ...
                <Flex gap="7" className="px-12">
                  ...
                  >
                    ...
                    >
                      ...
                      <Text className="text-base text-end ">
                        As the Founder & Chairman of Gadhiya Group, Bansil
                        Gadhiya brings over a decade of expertise in pioneering
                        medical equipment innovation. His extensive experience
                        spans a diverse range of roles, including working
                        closely with doctors, dealers, and importers to overcome
                        industry challenges and drive significant business
                        growth.
                      </Text>
                      <Flex gap="5">
                        <Text>
              ...
              <Flex direction="column" justify="center" align="center" gap="8">
                ...
                >
                  ...
                  <Text
                    weight="medium"
                    className="text-black text-xl sm:text-3xl"
                  >
                ...
                <Flex className="w-full font-semibold text-[22px] text-primary text-center !justify-center !sm:justify-between flex-wrap sm:flex-nowrap">
                  ...
                  <Flex direction="column" gap="4" px="5">
                    <img src={hospitalIcon} alt="About Us" className="h-auto" />
                    <Text>
                  ...
                  <Flex direction="column" gap="4" px="5">
                    <img src={wellnessIcon} alt="About Us" className="h-auto" />
                    <Text>Wellness</Text>
                  </Flex>
                </Flex>
              </Flex>
              ...
              <Flex
                direction="column"
                gap="8"
                className="bg-skyblue rounded-[20px] p-6 sm:p-12"
              >
                <Flex
                  direction="column"
                  justify="center"
                ...
                <Flex width="100%" justify="center">
                  <Flex
                    className="w-full lg:w-3/5 custom-card-container flex-col sm:flex-row"
                    gap="6"
                    justify="center"
                  >
                    <Card className="!p-5 w-full bg-white">
                      <Flex direction="column" gap="4">
                        ...
                        <Text
                          as="p"
                          size="3"
                          className="text-textskyblue font-normal text-center"
                        >
                          To enhance vision and eye health globally through
                          innovative, high-quality ophthalmic solutions and
                    ...
                    <Card className="!p-5 w-full !bg-white">
                      <Flex direction="column" gap="4">
                        ...
                        <Text
                          ...
                          className="text-textskyblue font-normal text-center"
                        >
                          To be the leading provider of cutting-edge eye care
                          technologies, ensuring clear vision and improved
              ...
              <Flex
                direction="column"
                gap="8"
                className="font-medium text-xl text-black text-center mb-12"
              >
                <Flex
                  direction="column"
                  justify="center"
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
                  {items.map((item, index) => (
                    ...
                    >
                      ...
                      <Text className="font-medium text-xl text-black text-center">
                        {item.label}
                      </Text>
                    </div>
                  ))}
